...
const patrolInfoContent = [
  {
    ...
    label: 'Season First Patrol Sept 26th',
      ...
      <Container maxWidth="lg" sx={{ textAlign: 'center' }}>
        <Box display="flex" justifyContent="center">
          <Stack sx={{ maxWidth: '800px' }}>
            ...
            <Typography variant="body2">Our favourite time of year is almost here again. South Curly beach patrol season is almost upon us.</Typography>
          </Stack>
        </Box>
