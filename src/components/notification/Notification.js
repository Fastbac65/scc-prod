...
const Notification = () => {
  ...
  return (
    <Snackbar open={alert?.open} autoHideDuration={alert.duration} onClose={handleClose} anchorOrigin={{ vertical: alert.posn || 'bottom', horizontal: 'center' }} sx={{ zIndex: '20000' }}>
